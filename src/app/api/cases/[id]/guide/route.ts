      ...
      if (caseData.source === "信访信息系统") {
        ...
        guideResult = {
          steps: [
            ...
            { step: 2, title: "平台点击受理", description: "如属于本部门职责，在平台上点击受理（注意：60日办理时限从点击受理之日起算）", deadline: "确认后15个自然日内", completed: false },
            ...
            { step: 5, title: "平台反馈", description: "在平台提交办理情况，逐条答复反映问题", deadline: "自点击受理之日起60个自然日内", completed: false },
          ],
          regulations: [],
          deadline_info: {
