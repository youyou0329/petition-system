...
async function main() {
  ...
  for (const r of results) {
    ...
    console.log(`-- ${r.name}`);
    console.log(`INSERT INTO guideline_docs (title, category, content, is_active) VALUES ('${r.name}', '${r.category}', '${escapedContent.substring(0, 3000)}...', true);`);
    console.log('');
  }
}
